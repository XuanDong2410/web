window.addEventListener('load',function(){
    ...
    function displayStatusText(context){
        ...
        context.fillText('Score: ' + score, canvas.width/10, 50 );
        context.fillStyle = 'white';
        context.fillText('Score: ' + score, canvas.width/10, 53 );
        if(gameOver){
            context.textAlign = 'center';
            context.fillStyle = 'black';
            context.fillText('GAME OVER',canvas.width/2,200);
            context.fillText('Try Again = Enter!',canvas.width/2,240);
            context.fillStyle = 'white';
            context.fillText('GAME OVER',canvas.width/2+2,200);
            context.fillText('Try Again = Enter!',canvas.width/2+2,240);
        }            
    }
